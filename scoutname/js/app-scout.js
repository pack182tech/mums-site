...
async function loadSettings() {
    ...
    try {
        ...
        // Update scout help text if available
        const scoutHelpText = document.getElementById('scout-help-text');
        if (scoutHelpText && settings.scout_help_text) {
            scoutHelpText.textContent = settings.scout_help_text;
        }
...
function saveCustomerInfo() {
    ...
    const data = {
        // Don't save scout name - each order should specify a scout
...
async function handleOrderSubmit(e) {
    ...
    // Prepare order data
    const orderData = {
        scoutName: form.scoutName.value,
        firstName: form.firstName.value,
        lastName: form.lastName.value,
        email: form.email.value,
        phone: form.phone.value,
